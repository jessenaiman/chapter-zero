...
* **Convenient interface** for running test-suites directly from Godot
  ...
  selected tests and display the results in the GdUnit Inspector.
  You can create new test cases directly from the ScriptEditor by right-clicking on the function you want to test and selecting "Create TestCase" from the context menu.<br/>
