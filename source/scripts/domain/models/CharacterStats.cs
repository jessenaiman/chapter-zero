...
namespace OmegaSpiral.Domain.Models
{
    ...
    public class CharacterStats
    {
        ...
        /// <summary>
        /// Gets the health percentage for the given current health value.
        /// </summary>
        ...
        /// <summary>
        /// Gets the mana percentage for the given current mana value.
        /// </summary>
        /// <param name="currentMana">The current mana value.</param>
        /// <returns>The mana percentage as a value between 0 and 1.</returns>
        public float GetManaPercentage(int currentMana)
        {
            if (this.MaxMana > 0)
            {
