...
namespace OmegaSpiral.Source.Scripts.Infrastructure
{
    ...
    public static class ConfigurationService
    {
        ...
        public static Godot.Collections.Dictionary<string, Variant> LoadConfiguration(string configPath)
        {
        ...
        public static Godot.Collections.Dictionary<string, Variant> LoadConfigurationFromString(string jsonContent, string sourceDescription = "JSON string")
        {
            if (string.IsNullOrWhiteSpace(jsonContent))
            {
        ...
        public static bool ValidateConfiguration(Godot.Collections.Dictionary<string, Variant> configData, string schemaPath)
        {
            try
            {
        ...
        /// <returns>True if the configuration is valid according to the schema, false otherwise.</returns>
        public static bool ValidateConfiguration(Godot.Collections.Dictionary<string, Variant> configData, Godot.Collections.Dictionary<string, Variant> schema)
        {
        ...
        private static Godot.Collections.Dictionary<string, Variant> ParseJsonContent(string jsonContent, string sourceDescription)
        {
