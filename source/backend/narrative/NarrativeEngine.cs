...
namespace OmegaSpiral.Source.Narrative
{
    ...
    public sealed class NarrativeEngine
    {
        ...
        public async Task PlayAsync(NarrativeScriptRoot script, INarrativeHandler handler)
        {
            ...
            var scenes = script.Scenes ?? new List<NarrativeScriptElement>();
        ...
        private async Task PlaySceneAsync(NarrativeScriptElement scene, INarrativeHandler handler)
        {
