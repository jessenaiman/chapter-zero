...
public partial class GamepieceController : Node
{
    ...
    /// </summary>
    public ReadOnlyCollection<Vector2I> MovePath => new ReadOnlyCollection<Vector2I>(this.movePath);
    ...
    public virtual void MoveAlongPath(ReadOnlyCollection<Vector2I> path)
    {
    ...
    public virtual void MoveToPressedKey(Vector2 direction)
    {
        ...
        {
            this.SetMovePath(new ReadOnlyCollection<Vector2I>(newPath.ToList()));
        }
    }
    ...
    /// </summary>
    /// <param name="path">The list of cell positions representing the path to follow.</param>
    private void SetMovePath(ReadOnlyCollection<Vector2I> path)
    {
        this.movePath = path != null ? path.ToList() : new List<Vector2I>();
