...
namespace OmegaSpiral.Source.Narrative
{
    ...
    public partial class NarrativeSceneData
    {
        ...
        /// <summary>
        /// Gets or sets the configuration data for the Echo Chamber stage (Stage 2).
        /// </summary>
        public EchoChamberData? EchoChamber { get; set; }

        /// <summary>
        /// Gets or sets the configuration data for the Echo Vault stage (Stage 3).
        /// </summary>
        public EchoVaultData? EchoVault { get; set; }
    }
    ...
    /// <summary>
    /// Root data payload for the Echo Chamber stage (Stage 2).
    /// </summary>
    public partial class EchoChamberData
    {
        ...
        public IList<EchoChamberDreamweaver> Dreamweavers { get; init; } = new List<EchoChamberDreamweaver>();

        /// <summary>Gets the ordered interludes preceding each chamber.</summary>
        public IList<EchoChamberInterlude> Interludes { get; init; } = new List<EchoChamberInterlude>();

        /// <summary>Gets the chamber definitions the player traverses.</summary>
        public IList<EchoChamberChamber> Chambers { get; init; } = new List<EchoChamberChamber>();
    ...
    /// <summary>
    /// Metadata surfaced by the Echo Chamber stage.
    /// </summary>
    public partial class EchoChamberMetadata
    {
    ...
    /// </summary>
    public partial class EchoChamberInterlude
    {
        ...
        public IList<EchoChamberOption> Options { get; init; } = new List<EchoChamberOption>();
    }

    /// <summary>
    /// Represents a selectable option used in interludes or chamber interactions.
    /// </summary>
    public partial class EchoChamberOption
    {
        /// <summary>Gets or sets the option identifier.</summary>
        public string Id { get; set; } = string.Empty;
    ...
    /// </summary>
    public partial class EchoChamberBanter
    {
        ...
        public IList<EchoChamberLine> Dissent { get; init; } = new List<EchoChamberLine>();
    }

    /// <summary>
    /// Represents a single speaker line.
    /// </summary>
    public partial class EchoChamberLine
    {
    ...
    /// </summary>
    public partial class EchoChamberChamber
    {
        ...
        public IList<EchoChamberObject> Objects { get; init; } = new List<EchoChamberObject>();

        /// <summary>Gets decoy echoes that collapse to static.</summary>
        public IList<EchoChamberDecoy> Decoys { get; init; } = new List<EchoChamberDecoy>();
    }

    /// <summary>
    /// Layout style for a chamber.
    /// </summary>
    public partial class EchoChamberStyle
    {
    ...
    /// </summary>
    public partial class EchoChamberObject
    {
    ...
    /// </summary>
    public partial class EchoChamberDecoy
    {
    ...
    /// </summary>
    public partial class EchoChamberFinale
    {
        /// <summary>Gets or sets the claimants dictionary.</summary>
        public Dictionary<string, EchoChamberFinaleClaimant> Claimants { get; init; } = new();
    ...
    /// </summary>
    public partial class EchoChamberFinaleClaimant
    {
        ...
        public IList<EchoChamberLine> Responses { get; init; } = new List<EchoChamberLine>();
    }

    /// <summary>
    /// Root data payload for Stage 3 - Echo Vault.
    /// </summary>
    public partial class EchoVaultData
    {
        ...
        public IList<EchoVaultPointsLedgerEntry> PointsLedger { get; init; } = new List<EchoVaultPointsLedgerEntry>();

        /// <summary>Gets the ordered beat list (selection/combat/finale).</summary>
        public IList<EchoVaultBeat> Beats { get; init; } = new List<EchoVaultBeat>();

        /// <summary>Gets the echo definition catalogue.</summary>
        public IList<EchoVaultEchoDefinition> EchoDefinitions { get; init; } = new List<EchoVaultEchoDefinition>();

        /// <summary>Gets special non-echo options (rerolls, duplicates).</summary>
        public IList<EchoVaultSpecialOption> SpecialOptions { get; init; } = new List<EchoVaultSpecialOption>();

        /// <summary>Gets the combat encounter table.</summary>
        public IList<EchoVaultCombat> Combats { get; init; } = new List<EchoVaultCombat>();
    ...
    /// <summary>Metadata for Echo Vault presentation.</summary>
    public partial class EchoVaultMetadata
    {
        ...
        public IList<EchoVaultPresentationTier> PresentationTiers { get; init; } = new List<EchoVaultPresentationTier>();
    }

    /// <summary>Represents a visual tier change.</summary>
    public partial class EchoVaultPresentationTier
    {
    ...
    public partial class EchoVaultPointsLedgerEntry
    {
    ...
    /// <summary>Represents a beat in the Echo Vault sequence.</summary>
    public partial class EchoVaultBeat
    {
        /// <summary>Gets or sets beat identifier.</summary>
        public string Id { get; set; } = string.Empty;
    ...
    /// <summary>Definition for a selectable echo (party member).</summary>
    public partial class EchoVaultEchoDefinition
    {
        /// <summary>Gets or sets echo identifier.</summary>
        public string Id { get; set; } = string.Empty;
        ...
        public EchoVaultMechanics Mechanics { get; set; } = new();
        ...
        public Dictionary<string, EchoVaultResponsePair> DreamweaverResponses { get; init; } = new();
    }

    /// <summary>Describes mechanics of an echo.</summary>
    public partial class EchoVaultMechanics
    {
    ...
    public partial class EchoVaultResponsePair
    {
    ...
    /// <summary>Represents a special non-echo option (reroll, duplicate).</summary>
    public partial class EchoVaultSpecialOption
    {
    ...
    public partial class EchoVaultCombat
    {
        /// <summary>Gets or sets encounter identifier.</summary>
        public string EncounterId { get; set; } = string.Empty;

        /// <summary>Gets enemy composition.</summary>
        public IList<EchoVaultEnemyEntry> EnemyList { get; init; } = new List<EchoVaultEnemyEntry>();
    ...
    public partial class EchoVaultEnemyEntry
    {
    ...
    public partial class EchoVaultPartyPersistence
    {
