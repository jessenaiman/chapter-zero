...
public sealed class PersonaConfig
{
    ...
    /// </summary>
    public Collection<string> OpeningLines { get; set; } = new();
    ...
    /// </summary>
    public Collection<PersonaStoryBlock> StoryBlocks { get; set; } = new();
...
public sealed class PersonaChoiceBlock
{
    ...
    /// </summary>
    public Collection<PersonaChoiceOption> Options { get; set; } = new();
}
...
public sealed class PersonaStoryBlock
{
    ...
    /// </summary>
    public Collection<string> Paragraphs { get; set; } = new();
    ...
    /// </summary>
    public Collection<PersonaNarrativeChoice> Choices { get; set; } = new();
}
