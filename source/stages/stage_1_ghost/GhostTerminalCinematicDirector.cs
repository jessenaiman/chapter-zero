...
{
    private const string _DataPath = "res://source/stages/stage_1_ghost/ghost.json";
    private const string _SchemaPath = "res://source/data/schemas/ghost_terminal_cinematic_schema.json";

    private static volatile GhostTerminalCinematicPlan? _CachedPlan;
    ...
    {
        var configuration = ConfigurationService.LoadConfiguration(_DataPath);

        if (!ConfigurationService.ValidateConfiguration(configuration, _SchemaPath))
        {
...
{
    /// <summary>The boot sequence beat.</summary>
    BootSequence,
    /// <summary>The monologue beat.</summary>
    Monologue,
    /// <summary>The initial choice beat.</summary>
    InitialChoice,
    /// <summary>The story introduction beat.</summary>
    StoryIntro,
    /// <summary>The story choice beat.</summary>
    StoryChoice,
    /// <summary>The story continuation beat.</summary>
    StoryContinuation,
    /// <summary>The secret setup beat.</summary>
    SecretSetup,
    /// <summary>The secret choice beat.</summary>
    SecretChoice,
    /// <summary>The name setup beat.</summary>
    NameSetup,
    /// <summary>The name choice beat.</summary>
    NameChoice,
    /// <summary>The exit beat.</summary>
    Exit
}
...
internal static class GhostTerminalCinematicDataExtensions
{
    ...
    public static GhostTerminalQuestion ToQuestion(this GhostTerminalSecretQuestion secretQuestion)
    {
        ...
        foreach (var option in secretQuestion.Options)
        {
            question.Options.Add(option);
        }
