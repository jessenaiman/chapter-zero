...
public partial class Question6Continue : TerminalBase
{
    ...
    private async Task DetermineAndDisplayThreadAsync()
    {
        ...
        await ApplyThreadVisualPresetAsync(dominantThread);
        await DisplayThreadDeterminationAsync(dominantThread);
        await DisplayScoreSummaryAsync();
        await DisplayExitLinesAsync(dominantThread);
        await HandleFinalTransitionAsync();
    }
    ...
    {
        TerminalVisualPreset preset = dominantThread switch
        {
