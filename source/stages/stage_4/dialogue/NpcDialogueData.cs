...
public class NpcDialogueData : BaseDialogueData
{
    ...
    /// </summary>
    public List<string> LiminalResponses { get; set; } = new();
    
    /// <summary>
    /// Gets or sets dialogue that references previous iterations of the town
    /// </summary>
    public List<string> MemoryFragments { get; set; } = new();
...
public class TownshipNarrativeBlock : BaseNarrativeBlock
{
    ...
    public TownshipNarrativeBlock(List<string> paragraphs, string question, List<IDialogueChoice> choices, int nextBlock)
        : base(paragraphs, question, choices, nextBlock)
    {
    }
}