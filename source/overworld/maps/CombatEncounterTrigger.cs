...
public partial class CombatEncounterTrigger : OmegaSpiral.Source.Scripts.Field.cutscenes.Trigger
{
    ...
    protected override async Task ExecuteAsync()
    {
        ...
        {
            await this.dialogic.StartTimelineAsync(this.PreCombatTimeline);
        }
        ...
        if (this.CombatArena != null && this.fieldEvents != null && this.combatEvents != null)
        {
            ...
            {
                await this.dialogic.StartTimelineAsync(this.VictoryTimeline);
            ...
            {
                await this.dialogic.StartTimelineAsync(this.LossTimeline);
