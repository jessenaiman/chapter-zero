...
namespace OmegaSpiral.Source.Scripts
{
    ...
    public partial class Music : Node
    {
        ...
        /// </summary>
        /// <returns>A collection containing the history of played music tracks.</returns>
        public Collection<AudioStream> GetMusicHistory()
        {
            return new Collection<AudioStream>(this.musicHistory);
        }
