...
namespace OmegaSpiral.Source.Scripts.Combat.UI
{
    ...
    public void AddActionEntry(Battler battler, BattlerAction action, ReadOnlyCollection<Battler> targets)
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="battler"/> is <c>null</c>.</exception>
    public void AddSpecialAbilityEntry(Battler battler, string abilityName, ReadOnlyCollection<Battler> targets)
        {
            ArgumentNullException.ThrowIfNull(battler);
    ...
    public void AddItemUsageEntry(Battler battler, string itemName, ReadOnlyCollection<Battler> targets)
        {
            ArgumentNullException.ThrowIfNull(battler);
