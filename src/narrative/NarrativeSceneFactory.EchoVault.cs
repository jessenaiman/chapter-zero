...
namespace OmegaSpiral.Source.Narrative
{
    internal static partial class NarrativeSceneFactory
    {
        private static EchoVaultData MapToEchoVault(Godot.Collections.Dictionary<string, Variant> data)
        {
            ...
            MapPointsLedger(data, vault);
            MapBeats(data, vault);
            MapEchoDefinitions(data, vault);
            MapSpecialOptions(data, vault);
            MapCombats(data, vault);
            MapOmegaLogs(data, vault);
        ...
        /// <summary>
        /// Maps the points ledger data to the vault.
        /// </summary>
        private static void MapPointsLedger(Godot.Collections.Dictionary<string, Variant> data, EchoVaultData vault)
        {
        ...
        /// <summary>
        /// Maps the beats data to the vault.
        /// </summary>
        private static void MapBeats(Godot.Collections.Dictionary<string, Variant> data, EchoVaultData vault)
        {
        ...
        /// <summary>
        /// Maps the echo definitions data to the vault.
        /// </summary>
        private static void MapEchoDefinitions(Godot.Collections.Dictionary<string, Variant> data, EchoVaultData vault)
        {
        ...
        /// <summary>
        /// Maps the special options data to the vault.
        /// </summary>
        private static void MapSpecialOptions(Godot.Collections.Dictionary<string, Variant> data, EchoVaultData vault)
        {
        ...
        /// <summary>
        /// Maps the combats data to the vault.
        /// </summary>
        private static void MapCombats(Godot.Collections.Dictionary<string, Variant> data, EchoVaultData vault)
        {
        ...
        /// <summary>
        /// Maps the omega logs data to the vault.
        /// </summary>
        private static void MapOmegaLogs(Godot.Collections.Dictionary<string, Variant> data, EchoVaultData vault)
        {
            AssignArray(data, "omega_logs", array => { foreach (var item in ExtractStringList(array)) vault.OmegaLogs.Add(item); });
        }
        ...
        private static EchoVaultMetadata MapToEchoVaultMetadata(Godot.Collections.Dictionary<string, Variant> dict)
        {
            ...
            AssignString(dict, "palette", value => metadata.Palette = value);
                AssignArray(dict, "system_intro", array => { foreach (var item in ExtractStringList(array)) metadata.SystemIntro.Add(item); });
        ...
        private static EchoVaultBeat MapToEchoVaultBeat(Godot.Collections.Dictionary<string, Variant> dict)
        {
            ...
            AssignDictionary(dict, "champion_whispers", whisperDict =>
            {
                ...
                AssignArray(dict, "options", array => { foreach (var item in ExtractStringList(array)) beat.Options.Add(item); });
            ...
            AssignString(dict, "tutorial_hint", value => beat.TutorialHint = value);
                AssignArray(dict, "omega_interrupts", array => { foreach (var item in ExtractStringList(array)) beat.OmegaInterrupts.Add(item); });
        ...
        private static EchoVaultCombat MapToEchoVaultCombat(Godot.Collections.Dictionary<string, Variant> dict)
        {
            ...
            AssignArray(dict, "enemy_list", array =>
            {
                ...
                AssignArray(dict, "log_style", array => { foreach (var item in ExtractStringList(array)) combat.LogStyle.Add(item); });
        ...
        private static EchoVaultPartyPersistence MapToPartyPersistence(Godot.Collections.Dictionary<string, Variant> dict)
        {
            ...
            AssignString(dict, "trigger_beat", value => persistence.TriggerBeat = value);
                AssignArray(dict, "fields_saved", array => { foreach (var item in ExtractStringList(array)) persistence.FieldsSaved.Add(item); });
