...
public partial class NarrativeAssetPreloader : Node
{
    ...
    /// </summary>
    /// <returns>A collection of all preloaded asset paths.</returns>
    public Collection<string> GetPreloadedAssetPaths()
    {
        return new Collection<string>(new List<string>(this.preloadedAssets.Keys));
    }
}
