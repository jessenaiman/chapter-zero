...
namespace OmegaSpiral.Ui.Menus
{
    ...
    {
        private const string StageManifestPath = "res://source/data/manifest.json";
...
#pragma warning restore CA2213
        ...
        private StageButton? CreateStageButton(ManifestStage stage)
        {
            ...
            stageButton.Connect(StageButton.SignalName.ClickedStage, Callable.From<string>(HandleStageButtonClicked));
