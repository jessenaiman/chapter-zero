// <copyright file="TestTerminalFunctionality.cs" company="Ωmega Spiral">
...
/// <summary>
/// Test script for verifying terminal UI functionality with existing narrative flow.
/// Tests all enhanced 2D/3D effects including ghost writing, dissolve transitions, and 3D display.
/// </summary>
[GlobalClass]
public partial class TestTerminalFunctionality : Node2D
{
    ...
    {
        // Get reference to the terminal UI component
        this.terminalUI = this.GetNode<TerminalUI>("TerminalUI");

        // Connect to terminal signals for testing
        ...
        this.CallDeferred(nameof(this.RunTerminalFunctionalityTestAsync));
    }

    private async void RunTerminalFunctionalityTestAsync()
    {
        try
        {
            GD.Print("Starting Terminal UI Functionality Test...");
            ...
            GD.Print("Terminal UI Functionality Test Completed Successfully!");
        ...
        {
            GD.PrintErr($"Terminal UI Functionality Test Failed: {ex.Message}");
    ...
    private async Task TestTerminalInitializationAsync()
    {
        ...
        await this.terminalUI.DisplayTextWithTypewriterAsync("Terminal UI Functionality Test Initialized");
    ...
    private async Task TestEnhancedGhostWritingAsync()
    {
        ...
        await this.WaitForSignalAsync(3.0f);
    ...
    private async Task TestEnhancedTextScramblingAsync()
    {
        ...
        await this.WaitForSignalAsync(2.0f);
    ...
    public override void _Process(double delta)
    {
        ...
        {
            // The depth perception is handled in TerminalUI._Process
