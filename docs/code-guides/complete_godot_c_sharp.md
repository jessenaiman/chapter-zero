...
```csharp
string name = "World";
Callable sayHello = new Callable(() => SayHello(name));
...
used with operands of the types `Task`, `Task`, `ValueTask`, or `ValueTask`.
...
.. _`Task<TResult>`: https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.task-1
.. _ValueTask: https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.valuetask
.. _`ValueTask<TResult>`: https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.valuetask-1
