...
tools: ['edit', 'search', 'new', 'runCommands', 'runTasks', 'context7/*', 'godot/*', 'oraios/serena/*', 'microsoftdocs/mcp/*', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos', 'runTests']
---
