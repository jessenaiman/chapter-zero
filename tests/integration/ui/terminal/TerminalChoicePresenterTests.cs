...
namespace OmegaSpiral.Tests.Unit.Common.Terminal
{
    ...
    public class TerminalChoicePresenterTests
    {
        ...
        {
            // Arrange
            var choiceOptions = new Collection<TerminalChoiceOption>
            {
                new TerminalChoiceOption { Text = "Option 1", TextColor = Colors.Red },
                new TerminalChoiceOption { Text = "Option 2", IsSelected = true },
                new TerminalChoiceOption { Text = "Option 3" }
            };
        ...
        {
            _presenter.PresentChoicesAsync((Collection<TerminalChoiceOption>)null!).Wait();
        }
    }
}
