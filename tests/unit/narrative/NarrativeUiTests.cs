...
public class NarrativeUiTests
{
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_InitializesWithDefaults()
    {
        // Arrange & Act
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsCustomValues()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsNullVisualPreset()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsZeroDelay()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsCustomTypingSpeed()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsNegativeDelay()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsVerySlowTypingSpeed()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsEmptyTextWithEffects()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsVeryFastTypingSpeed()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
    ...
    /// </summary>
    [TestCase]
    public static void NarrativeBeat_SupportsLongDelay()
    {
        // Arrange & Act
        var beat = new NarrativeUi.NarrativeBeat
        {
