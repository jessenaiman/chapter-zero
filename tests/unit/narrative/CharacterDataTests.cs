...
public class CharacterDataTests
{
    ...
    /// </summary>
    [TestCase]
    public static void CharacterData_InitializesWithDefaults()
    {
        // Arrange & Act
    ...
    /// </summary>
    [TestCase]
    public static void CharacterData_InitializesWithProvidedValues()
    {
        // Arrange & Act
        var character = new CharacterData(
            "wizard",
    ...
    /// </summary>
    [TestCase]
    public static void FromDictionary_CreatesCharacterData()
    {
        // Arrange
    ...
    /// </summary>
    [TestCase]
    public static void FromDictionary_HandlesMissingFields()
    {
        // Arrange
        var dict = new Godot.Collections.Dictionary<string, Variant>();
    ...
    /// </summary>
    [TestCase]
    public static void FromDictionary_HandlesEmptyDictionary()
    {
        // Arrange
        var dict = new Godot.Collections.Dictionary<string, Variant>();
    ...
    /// </summary>
    [TestCase]
    public static void ToCharacter_ConvertsFighter()
    {
        // Arrange
        ...
        AssertThat(character.Identity).IsNotNull();
        AssertThat(character.Identity.Name).IsEqual("Arthur");
    ...
    /// </summary>
    [TestCase]
    public static void ToCharacter_ConvertsWizard()
    {
        // Arrange
        ...
        AssertThat(character).IsNotNull();
        AssertThat(character.Identity).IsNotNull();
        AssertThat(character.Identity.Name).IsEqual("Merlin");
        AssertThat(character.Class).IsNotNull();
    }
    ...
    /// </summary>
    [TestCase]
    public static void ToCharacter_ConvertsThief()
    {
        // Arrange
        ...
        AssertThat(character).IsNotNull();
        AssertThat(character.Identity).IsNotNull();
        AssertThat(character.Identity.Name).IsEqual("Robin");
        AssertThat(character.Class).IsNotNull();
    }
    ...
    /// </summary>
    [TestCase]
    public static void ToCharacter_ConvertsScribe()
    {
        // Arrange
        ...
        AssertThat(character).IsNotNull();
        AssertThat(character.Identity).IsNotNull();
        AssertThat(character.Identity.Name).IsEqual("Brother Cadfael");
        AssertThat(character.Class).IsNotNull();
    }
    ...
    /// </summary>
    [TestCase]
    public static void ToCharacter_DefaultsUnknownToFighter()
    {
        // Arrange
        ...
        AssertThat(character).IsNotNull();
        AssertThat(character.Identity).IsNotNull();
        AssertThat(character.Identity.Name).IsEqual("Mystery");
        AssertThat(character.Class).IsNotNull();
    }
    ...
    /// </summary>
    [TestCase]
    public static void ToString_HandlesEmptyData()
    {
        // Arrange
        var character = new CharacterData();
