...
public partial class Stage1MenuIntegrationTests : Node
{
    ...
    private const string Beat1BootSequencePath = "res://source/stages/stage_1/beats/boot_sequence.tscn";
    private const string Beat2OpeningMonologuePath = "res://source/stages/stage_1/beats/opening_monologue.tscn";
    ...
    public void Stage1ManifestFirstSceneShouldBeBootSequence()
    {
        ...
        AssertThat(firstScene!.Id).IsEqual("beat_1_boot_sequence");
    ...
    public void Stage1BeatSequenceShouldProgressCorrectly()
    {
        ...
        AssertThat(beat1!.Id).IsEqual("beat_1_boot_sequence");

        var beat2Id = manifest.GetNextSceneId("beat_1_boot_sequence");
        AssertThat(beat2Id).IsEqual("beat_2_opening_monologue");
        ...
        var beat3Id = manifest.GetNextSceneId("beat_2_opening_monologue");
        AssertThat(beat3Id).IsEqual("beat_3_question_1_name");

        // Verify last beat has no next scene (completion)
        var beat8Id = manifest.GetNextSceneId("beat_7_name_question");
        AssertThat(beat8Id).IsEqual("beat_8_exit");

        var beat9Id = manifest.GetNextSceneId("beat_8_exit");
    ...
    public void AllEightBeatScenesShouldLoadSuccessfully()
    {
        ...
        var beatPaths = new[]
        {
            "res://source/stages/stage_1/beats/boot_sequence.tscn",
            "res://source/stages/stage_1/beats/opening_monologue.tscn",
            "res://source/stages/stage_1/beats/question_1_name.tscn",
            "res://source/stages/stage_1/beats/story_fragment.tscn",
            "res://source/stages/stage_1/beats/secret_question.tscn",
            "res://source/stages/stage_1/beats/secret_reveal.tscn",
            "res://source/stages/stage_1/beats/name_question.tscn",
            "res://source/stages/stage_1/beats/exit.tscn",
        };
