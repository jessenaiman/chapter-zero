...
public partial class OmegaContainer_UnitTests
{
    ...
    public void Cleanup()
    {
        if (_Container != null)
        {
            GD.Print("Freeing TestContainer...");
    ...
    [TestCase]
    [RequireGodotRuntime]
    public async Task Ready_EmitsInitializationCompletedSignal()
    {
        // Arrange
        var sceneTree = (SceneTree)Engine.GetMainLoop();
        ...
        // Cleanup
        sceneTree.Root.RemoveChild(_Container);
        _Container.QueueFree();
    }
    ...
    public void ComposeShaderController_CreatesShaderController()
    {
        ...
        // Cleanup
        sceneTree.Root.RemoveChild(container);
    }
