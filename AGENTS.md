...
A classic RPG rooted in Final Fantasy-style turn-based combat, reimagined with a spiraling, player-driven twist. This strategy kicks off with a free, glitchy alpha tied to the Silent Weaver’s (Omega’s) awakening—players uncover the truth

## Dreamweavers (use dialogic and nobodywho plugin)

Imagine a world where every choice you make summons one Dreamweaver to guide your band of adventurers, their tale vivid and alive. HERO might lead with radiant hope, SHADOW with passive neutrality and yearning for the days gone, or AMBITION with brooding power—each embodying a moral thread. Yet, beyond your sight, the other Dreamweavers weave their own unseen chronicles, their adventurers roaming the same fractured realm, shaped by the echoes of your decisions.

## C# Documentation and Async Standards

**ALWAYS CHECK THE BUILD AFTER EVERY NEW FILE AND CHANGE**
**FIX ALL ISSUES WITH ANY FILES YOU TOUCH BEFORE MOVING ON**
...
- Do not remove new functionality
- Remove duplication where found with the open-rpg-godot being the template to match which file should remain 
- All issues reported by codacy through a pull request must be discussed before completing a task
